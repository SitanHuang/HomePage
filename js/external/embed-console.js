var EmbedConsole = ( function() {
  ...
  var buildLogItem = function (sandbox, input, output, klass, stringify, outputClass ) {
    outputClass = outputClass || "nohighlight";
    ...
    if ( ! (output instanceof Error) && stringify != false ){
      ...
      output = typeof json == "undefined" ? (output?.toString() + "") : json;
  ...
  EmbedConsole.prototype = {
    ...
    add: function( opts ) {
      var logItem = buildLogItem( this, opts.input, opts.output, opts.klass, opts.javascript, opts.outputClass );
